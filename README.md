...
This project shows how "events" generated by Spark applications can be analyzed for profiling them.
...
This project uses Spark itself in local or cluster mode to analyze Spark application events from Spark 1.6 or higher.
